...
default['wordpress']['db']['root_password'] = 'KiboTest16!' #<- very unsecure, needs databag & encryption
default['wordpress']['db']['instance_name'] = 'test-instance'
...
default['wordpress']['php_options'] = { 'php_admin_value[upload_max_filesize]' => '250M', 'php_admin_value[post_max_size]' => '55M' }
